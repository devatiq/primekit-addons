...
class Main extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'primekit_elementor_search_form_border',
                'selector' => '{{WRAPPER}} .primekit-ele-search-form input[type=text]',
                'exclude' => ['color'],
            ]
        );
        ...
        // Border Radius
        $this->add_responsive_control(
            'primekit_elementor_search_form_border_radius',
            [
                'label' => esc_html__('Border Radius', 'primekit-addons'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .primekit-ele-search-form input[type=text]' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'primekit_elementor_search_form_btn_border',
                'selector' => '{{WRAPPER}} .primekit-ele-search-form input[type="submit"]',
            ]
        );
        ...
        //Border Radius
        $this->add_responsive_control(
            'primekit_elementor_search_form_btn_border_radius',
            [
                'label' => esc_html__('Border Radius', 'primekit-addons'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .primekit-ele-search-form input[type="submit"]' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        //Border Color
        $this->add_control(
            'primekit_elementor_search_form_btn_hover_border_color',
            [
                'label' => esc_html__('Border Color', 'primekit-addons'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .primekit-ele-search-form input[type="submit"]:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
