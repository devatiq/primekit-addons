...
$fallback_image = PRIMEKIT_ELEMENTOR_ASSETS . '/img/img-hover-placeholder.jpg';
...
// Get post limit
if('style2' == $settings['primekit_modern_post_grid_style']) {
...
$fullWidth_class = (1 === $post_limit) ? ' primekit-modern-one-post' : '';
