<?php
/**
 * Render View for ABC Modern Post Grid style 2
 */
if (!defined('ABSPATH'))
    ...
    <div class="primekit-modren-posts-styl2-wrapper">
        ...
        if ($posts->have_posts()):
            while ($posts->have_posts()):
                ...
                if ($counter === 1):
                    ?>
                    <div class="primekit-modren-style2-single-post <?php echo esc_attr($fullWidth_class); ?>">
                        <!-- Post Thumbnail -->
                ...
                <?php else:
                    ...
                    <div class="primekit-modren-style2-single-post">
                        <!-- Post Thumbnail -->
                        <div class="primekit-modren-style2-post-thumbnail">
                            <?php if (has_post_thumbnail()): ?>
                                <?php the_post_thumbnail('full'); ?>
