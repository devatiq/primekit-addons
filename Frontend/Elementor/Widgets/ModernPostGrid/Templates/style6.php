<?php
/**
 * Render View for Modern Post Grid style 6
 */
if (!defined('ABSPATH'))
...
<div class="primekit-modren-posts-grid-area">
    <div class="primekit-modren-posts-grid-wrapper primekit-modren-posts-grid-style3 primekit-modren-posts-grid-style6">
        <?php
