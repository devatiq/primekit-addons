...
<!-- CTA Area -->
<div class="primekit-cta-area<?php if ('yes' == $primekit_cta_zoom_effect) : echo esc_attr(' primekit-cta-zoom-effect-disabled'); endif; ?>">


    <?php if('yes' == $primekit_cta_ribbon) : ?>
        <!-- CTA Ribbon Area -->
        <div class="primekit-cta-ribbon-area <?php if ('left' == $primekit_cta_ribbon_position) : echo esc_attr('primekit-left-rabbon'); endif; ?>">
    ...
    <div class="primekit-cta-content-area">
        ...
        <?php if(!empty($primekit_description)) : ?>
            <div class="primekit-cta-description">            
                <?php echo wpautop(esc_html($primekit_description)); ?>         
            </div>
        <?php endif; ?>
    ...
    <?php if(!empty($primekit_btn1_text) || !empty($primekit_btn2_text)) : ?>
        ...
        <div class="primekit-cta-button-area">
            <?php if(!empty($primekit_btn1_text)) : ?>
                <a <?php echo $this->get_render_attribute_string( 'primekit_cta_button_link_one' ); ?> class="primekit-cta-button"><?php echo esc_html($primekit_btn1_text); ?></a>
            <?php endif; ?>
            <?php if(!empty($primekit_btn2_text)) : ?>
                <a <?php echo $this->get_render_attribute_string( 'primekit_cta_button_link_two' ); ?> class="primekit-cta-button"><?php echo esc_html($primekit_btn2_text); ?></a>
            <?php endif; ?>
        </div><!--/ CTA Button -->
    <?php endif; ?>
</div><!--/ CTA Area -->