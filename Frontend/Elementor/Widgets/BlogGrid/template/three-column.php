...
<div class="primekit-ele-three-column-blog-area">
    <div class="primekit-ele-three-column-blog"><!-- start primekit-ele-three-column-blog -->
        <?php
...
<?php echo '<img src="' . esc_url(primekit_Assets . '/img/blog/img-placeholder.jpg') . '" alt="' . esc_attr(get_the_title()) . '">'; ?>
                        ...
                        <?php if ($primekit_read_more_switch === 'yes') : ?>
                            <div class="primekit-ele-blog-more"><a href="<?php the_permalink(); ?>"><?php echo esc_html($primekit_grid_read_more_text); ?></a></div>
                        <?php endif; ?>
