                    ...
                    <div class="primekit-ele-single-blog-thumbnail">
                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                            ...
                            if (has_post_thumbnail()) {
                                ...
                                echo '<img src="' . esc_attr(PRIMEKIT_ELEMENTOR_ASSETS) . '/img/blog/image-placeholder.jpg" alt="abcbiz multi addon">';
                            }
                            ?>
                        </a>
                    </div><!--/ Thumbnail -->
                        ...
                        <div class="primekit-ele-single-blog-thumbnail">
                            <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                                ...
                                if (has_post_thumbnail()) {
                                    ...
                                    echo '<img src="' . esc_attr(PRIMEKIT_ELEMENTOR_ASSETS) . '/img/blog/image-placeholder.jpg" alt="abcbiz multi addons">';
                                }
                                ?>
                            </a>
                        </div><!--/ Thumbnail -->
