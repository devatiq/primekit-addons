...
class Main extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'primekit-elementor-loading-screen',
			[
		...
		//Heading tag
		$this->add_control(
			'primekit_elementor_loading_screen_tag',
			[
		...
		$this->add_responsive_control(
			'primekit_elementor_loading_screen_align',
			[
				'label' => esc_html__('Alignment', 'primekit-addons'),
				...
				'selectors' => [
					'{{WRAPPER}} .primekit-elementor-loading-screen-area' => 'text-align: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			'primekit_elementor_loading_screen_color',
			[
				'label' => esc_html__('Color', 'primekit-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '#cccccc',
				'selectors' => [
					'{{WRAPPER}} .primekit-loading-screen-tag' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'primekit_elementor_loading_screen_typography',
				'label' => esc_html__('Typography', 'primekit-addons'),
				'selector' => '{{WRAPPER}} .primekit-loading-screen-tag',
			]
		);
