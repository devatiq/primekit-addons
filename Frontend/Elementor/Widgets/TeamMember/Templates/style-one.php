<?php
/**
 * Render View file for Team Member 1.
 */
if (!defined('ABSPATH')) exit; // Exit if accessed directly

$primekit_settings = $this->get_settings_for_display();
$primekit_style_one_id = $this->get_id();
...
<div class="primekit-elementor-team-member-area primekit-team-style-one" id="primekit-team-member-<?php echo esc_attr($primekit_style_one_id); ?>">

    <!-- Team Member Single Item -->
    <div class="primekit-elementor-teammember-single-item-area">
        <div class="primekit-ele-team-single-item">

            <?php if ($primekit_settings['primekit_elementor_teammember_display_social'] == 'yes') : ?>
                <!-- Social Profile -->
                <div class="primekit-ele-team-social">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="primekit-ele-team-social-overlay">
          ...
          ?>
           <img src="<?php echo esc_url($primekit_member_image_url); ?>" alt="<?php echo esc_html($primekit_member_name); ?>">
            ...
            <!-- Team Member Content -->
            <div class="primekit-ele-team-footer">
                <div class="primekit-ele-team-content">
                    <?php if (!empty($primekit_member_name)) : ?>
                        <h4 class="primekit-ele-team-name">
                        <?php if (!empty($primekit_member_link)) : ?>
                        <a href="<?php echo esc_url($primekit_member_link); ?>">
                        <?php endif; ?>
                         <?php echo esc_html($primekit_member_name); ?></h4>
                         <?php if (!empty($primekit_member_link)) : ?>
                         </a>
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <?php if (!empty($primekit_member_link)) : ?>
                    <div class="primekit-ele-team-link">
                        <a href="<?php echo esc_url($primekit_member_link); ?>"><svg id="fi_9220013" enable-background="new 0 0 100 100" height="512" viewBox="0 0 100 100" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m75 52h-41.61c-1.1 0-2-.9-2-2s.9-2 2-2h41.61c1.1 0 2 .9 2 2s-.9 2-2 2z"></path><circle clip-rule="evenodd" cx="15.23" cy="50" fill-rule="evenodd" r="2"></circle><circle clip-rule="evenodd" cx="24.31" cy="50" fill-rule="evenodd" r="2"></circle><path d="m61.72 67.62c-.46 0-.92-.16-1.29-.48-.84-.72-.94-1.98-.23-2.82l12.18-14.32-12.18-14.33c-.72-.84-.61-2.1.23-2.82.84-.71 2.1-.61 2.82.23l13.27 15.62c.64.75.64 1.84 0 2.59l-13.28 15.63c-.39.47-.96.7-1.52.7z"></path><path d="m74.22 67.62c-.46 0-.92-.16-1.29-.48-.84-.72-.94-1.98-.23-2.82l12.18-14.32-12.18-14.33c-.72-.84-.61-2.1.23-2.82.84-.71 2.1-.61 2.82.23l13.27 15.62c.64.75.64 1.84 0 2.59l-13.28 15.63c-.39.47-.96.7-1.52.7z"></path></svg></a>
                    </div>
                <?php endif; ?>
