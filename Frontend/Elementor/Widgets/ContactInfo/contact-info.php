...
<?php if (!empty($primekit_settings['primekit_elementor_contact_info_address'])) : ?>
        <div class="primekit-contact-info-address">
            ...
            <span><?php echo esc_html($primekit_settings['primekit_elementor_contact_info_address']); ?></span>
        </div>
    <?php endif; ?>

    <?php if (!empty($primekit_settings['primekit_elementor_contact_info_mobile'])) : ?>
        <div class="primekit-contact-info-mobile">
            ...
            <span><a href="tel:<?php echo esc_attr($primekit_settings['primekit_elementor_contact_info_mobile']); ?>"><?php echo esc_html($primekit_settings['primekit_elementor_contact_info_mobile']); ?></a></span>
        </div>
    <?php endif; ?>

    <?php if (!empty($primekit_settings['primekit_elementor_contact_info_email'])) : ?>
        <div class="primekit-contact-info-email">
            ...
            <span><a href="mailto:<?php echo esc_attr($primekit_settings['primekit_elementor_contact_info_email']); ?>"><?php echo esc_html($primekit_settings['primekit_elementor_contact_info_email']); ?></a></span>
        </div>
    <?php endif; ?>