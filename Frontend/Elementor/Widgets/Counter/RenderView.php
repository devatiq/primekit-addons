...
<div class="primekit-ele-countdown-area">
  <div class="primekit-ele-countdown-wrap">
    ...
    <div class="primekit-ele-counter">
      <span
        class="primekit-counter"><?php echo esc_html($primekit_settings['primekit_elementor_counter_number']); ?></span>
      <span
        class="primekit-ele-counter-suffix"><?php echo esc_html($primekit_settings['primekit_elementor_counter_suffix']); ?></span>
    </div>
