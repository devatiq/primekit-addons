...
<div id="primekit-slider-<?php echo esc_attr($unique_id); ?>" class="primekit-addons-template-slider-wrapper"
    data-settings='<?php echo esc_attr($slider_settings); ?>'>
    <div class="primekit-template-swiper-container">
        <div class="primekit-template-swiper-wrapper">
            <!-- Dynamically render each slide -->
            <?php if (!empty($settings['slides'])): ?>
                <?php foreach ($settings['slides'] as $slide): ?>
                    <div class="primekit-template-swiper-slide">
