            ...
            <div id="primekit-custom-header" class="primekit-custom-header">
                ...
                <div class="primekit-banner-area">
                    ...
                    <div class="primekit-resource-buttons">                
                        ...
                        <a href="<?php echo esc_url(admin_url( 'admin.php?page=abcbiz_widgets_menu' )); ?>" class="button"><?php echo esc_html__( 'Avilable Widgets', 'primekit-addons' ); ?><span class="dashicons dashicons-arrow-right-alt"></span></a>
                    </div>
                </div>         
            </div>
